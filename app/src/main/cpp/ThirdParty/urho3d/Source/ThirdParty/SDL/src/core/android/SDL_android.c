...
JNIEXPORT int JNICALL SDL_JAVA_INTERFACE(nativeRunMain)(JNIEnv *env, jclass cls, jstring library, jstring function, jobject array)
{
    ...
    __android_log_print(ANDROID_LOG_VERBOSE, "SDL", "nativeRunMain() 1");

    library_file = (*env)->GetStringUTFChars(env, library, NULL);
    library_handle = dlopen(library_file, RTLD_GLOBAL);

    __android_log_print(ANDROID_LOG_VERBOSE, "SDL", "nativeRunMain() 2");
    ...
    __android_log_print(ANDROID_LOG_VERBOSE, "SDL", "nativeRunMain() 3");
    ...
    if (library_handle) {
        ...
        __android_log_print(ANDROID_LOG_VERBOSE, "SDL", "nativeRunMain() 4");
        ...
        if (SDL_main) {
            ...
            __android_log_print(ANDROID_LOG_VERBOSE, "SDL", "nativeRunMain() 5");
            ...
            __android_log_print(ANDROID_LOG_VERBOSE, "SDL", "nativeRunMain() 6");
            ...
            __android_log_print(ANDROID_LOG_VERBOSE, "SDL", "nativeRunMain() 7");
            
            /* Run the application. */
            status = SDL_main(argc, argv);

            __android_log_print(ANDROID_LOG_VERBOSE, "SDL", "nativeRunMain() 8");
        ...
        __android_log_print(ANDROID_LOG_VERBOSE, "SDL", "nativeRunMain() 9");
    ...
    __android_log_print(ANDROID_LOG_VERBOSE, "SDL", "nativeRunMain() 10");
    ...
    __android_log_print(ANDROID_LOG_VERBOSE, "SDL", "nativeRunMain() 11");
