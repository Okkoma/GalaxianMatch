...
// Modified by OkkomaStudio (2022-2024)
...
public class SDLActivity extends AppCompatActivity implements View.OnSystemUiVisibilityChangeListener {
    ...
    {
        mLayout.setContentDescription("main screen");
        mLayout.setImportantForAccessibility(4);//IMPORTANT_FOR_ACCESSIBILITY_NO_HIDE_DESCENDANTS
